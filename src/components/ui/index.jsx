      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            style={{ position: 'fixed', top: 'calc(env(safe-area-inset-top) + 72px)', left: '1rem', right: '1rem', maxHeight: 'calc(100vh - env(safe-area-inset-top) - env(safe-area-inset-bottom) - 88px)', zIndex: 260 }}
            className={clsx(
